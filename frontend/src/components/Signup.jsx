...
const Signup = () => {
  ...
  return (
    <div className='flex items-center justify-center w-screen h-screen'>
      <form onSubmit={submitHandler} className='flex flex-col gap-3 bg-white p-4 rounded-sm w-[20%]'>
        ...
        <button type="submit" className='bg-gray-400 p-2 rounded-xl text-white'>Sign Up</button>
